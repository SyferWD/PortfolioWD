    ...
    <section className="flex flex-col items-center xl:grid xl:grid-cols-2 xl:items-start min-h-screen">
        ...
        <div className="flex flex-col justify-center items-center mt-12 2xl:justify-start xl:items-end xl:mt-20 2xl:mt-40">
            <div className="flex flex-col justify-center items-center gap-8 px-10 xl:items-start xl:gap-6 2xl:gap-14 ">
                ...
                {/* About me text */}
                <div className=" text-lg text-wrap w-11/12 leading-6 tracking-[0.0125rem] text-center p-3 xl:text-left xl:min-w-[480px] xl:max-w-[640px] bg-gradient-to-b from-blue-400 to-blue-600 text-white rounded-lg theme_border shadow-custom-grey-neu dark:from-dm-yellow dark:to-dm-yellow dark:text-black dark:border-black">
                    <p>
